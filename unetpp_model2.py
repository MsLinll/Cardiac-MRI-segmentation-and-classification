...
# Base block network, used to stack to form each convolutional block
...
class Unetplusplus(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.deep_supervision:
            ...
            return [output1, output2, output3, output4]  # deep supervision
...
if __name__ == '__main__':
    ...
    print(net)
    print("Total number of paramerters in networks is {}".format(sum(p.numel() for p in net.parameters())))
